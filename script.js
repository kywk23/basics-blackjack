...
var winLoseDraw = function () {
  ...
  if (playerTotalPoints <= 21 && playerTotalPoints > computerTotalPoints) {
    return `You have ${playerTotalPoints} and you win. <br><br> ${winLoseMessagePlayer} <br><br> ${winLoseMessageComputer}`;
  } else if (
    computerTotalPoints <= 21 &&
    computerTotalPoints > playerTotalPoints
  ) {
    return `Computer has ${computerTotalPoints} and wins. <br><br> ${winLoseMessagePlayer} <br><br> ${winLoseMessageComputer}`;
